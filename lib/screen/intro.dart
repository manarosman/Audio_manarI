...
import 'package:helloworld/screen/main/main_page.dart';
...
//      width: MediaQuery.of(context).size.width,
        decoration: BoxDecoration(
            ...
            image: DecorationImage(
                image: NetworkImage(
                    'https://d27jswm5an3efw.cloudfront.net/app/uploads/2019/11/audio-file-types-32.jpg'))),
        child: Stack(
          children: <Widget>[
            PageView(
              onPageChanged: (value) {
              ...
              children: <Widget>[
                Column(
                  ...
                  children: <Widget>[
                    Center(
                      child: Image.network(
                        'https://m.media-amazon.com/images/I/51ZlS59MygL.jpg',
                        height: 200,
                        width: 200,
                      ),
                    ),
                ...
                Column(
                  ...
                  children: <Widget>[
                    Center(
                      child: Image.network(
                        'https://asmpick.com/wp-content/uploads/2023/02/new-bee-bluetooth-handsfree-v5.0-wireless-headphones-with-mic.jpg',
                        height: 200,
                        width: 200,
                      ),
                    ),
                ...
                Column(
                  ...
                  children: <Widget>[
                    Center(
                      child: Image.network(
                        'https://moskymasr.com/wp-content/uploads/2021/09/02-1-1.jpg',
                        height: 200,
                        width: 200,
                      ),
                    ),
