...
import 'package:helloworld/screen/address/add_address_page.dart';
import 'package:helloworld/screen/payment/unpaid_page.dart';
import 'package:flutter/material.dart';

import 'componts/credit_card.dart';
import 'componts/shop_item_list.dart';
...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  List<Product> products = [
    Product('assets/headphones.png', ' 400 On-Ear \n Bluetooth Headphones',
        '\n', 45.3),
    Product('assets/headphones_2.png',
        'Boat roackerz 100 On-Ear \n Bluetooth Headphones', '\n', 22.3),
    Product('assets/headphones_3.png',
        'Boat roackerz 300 On-Ear \n Bluetooth Headphones', '\n', 58.3)
  ];
